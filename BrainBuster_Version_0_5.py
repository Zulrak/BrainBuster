# Source File Name: BrainBuster_Version_0_5
# Author's Name: Jordan Cooper
# Last Modified By: Jordan Cooper
# Date Last Modified: Friday, July 15, 2013
""" 
  Program Description:  Brain Buster is a side scroller game where the user must consume as many brains
        ...
        Version: 0.5    - Added Sound to all collisions
                        - Added a soundtrack to the game [BONUS?]
"""
import random
import pygame
pygame.init()
...
def GameScreen():
    ...
    dougTheZombie.backgroundSound.stop()
    #return mouse cursor
